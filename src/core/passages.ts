...
const PASSAGES: Passage[] = [
  ...
  {
    id: "q7",
    text: "Make something people want. That is the fundamental challenge of a startup, and it is deceptively difficult to get right.",
    difficulty: "medium",
    source: "Paul Graham",
    category: "quotes",
    wordCount: 20,
  ...
  {
    id: "m8",
    text: "The cursor blinks patiently on the empty screen, waiting for the first keystroke that will set everything in motion.",
    difficulty: "medium",
    wordCount: 18,
    charCount: 115,
  },
  {
    id: "m9",
    text: "Late at night, when the world is quiet, the keyboard becomes an instrument and the coder becomes a composer of logic.",
    difficulty: "medium",
    wordCount: 21,
    charCount: 117,
  },
  {
    id: "e7",
    text: "Coffee in hand, headphones on, ready to build something that matters today.",
    difficulty: "easy",
    wordCount: 12,
    charCount: 74,
  },
  {
    id: "e8",
    text: "Ship fast, learn faster. Every line of code is a step toward mastery.",
    difficulty: "easy",
    wordCount: 12,
    charCount: 70,
  },
  ...
  {
    id: "code6",
    text: "git commit -m 'feat: add user authentication with OAuth 2.0 and session management'",
    difficulty: "medium",
    source: "Git",
    category: "code",
    wordCount: 10,
  ...
  {
    id: "code7",
    text: "const [data, setData] = useState<User[]>([]); useEffect(() => { fetchUsers().then(setData); }, []);",
    difficulty: "hard",
    source: "React Hooks",
    category: "code",
    wordCount: 9,
